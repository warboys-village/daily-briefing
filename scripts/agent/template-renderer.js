...
function renderFullBriefingHtml(data, villageName, county) {
  ...
  md += `<div class="wpa-callout-banner" style="background: linear-gradient(135deg, #034f32, #056842); color: #ffffff; padding: 1.1rem 1.25rem; border-radius: 8px; margin-bottom: 1.75rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.75rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">\n`;
  md += `  <div>\n`;
  ...
  md += `  </div>\n`;
  md += `  <a href="/wpa/" class="button-link" style="background: #ffffff; color: #034f32; font-weight: 700; font-size: 0.85rem; padding: 0.4rem 0.9rem; text-decoration: none; border-radius: 6px;">View WPA School Briefing &rarr;</a>\n`;
  md += `</div>\n\n`;
